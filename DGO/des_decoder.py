...
# out:Tensor("fusion/fusion_model/concat_6:0", shape=(?, 132, 132, 128), dtype=float32)
# decoder out: (?, 132, 132, 64)
# decoder out: (?, 132, 132, 32)
# decoder out: (?, 132, 132, 16)
# decoder out: (?, 132, 132, 1)
# out:Tensor("fusion/fusion_model/add:0", shape=(?, 132, 132, 64), dtype=float32)
# decoder out: (?, 132, 132, 64)
# decoder out: (?, 132, 132, 32)
# decoder out: (?, 132, 132, 16)
# decoder out: (?, 132, 132, 1)
